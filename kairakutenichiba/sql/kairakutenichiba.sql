...
create table purchases_outlines (
	...
	delivery enum('メール便','宅配便'),/*配送方法*/
	credit_number varchar(16) not null,/*クレジットカード番号*/
...
(8,'美しいホネ','ライトノベル','2099-12-31','山田太郎','快楽社','文庫',215,9874963258741,620,1000,"商品詳細","img/item/美しいホネ.png"),
